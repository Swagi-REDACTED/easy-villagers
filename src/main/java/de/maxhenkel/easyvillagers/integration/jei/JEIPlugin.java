...
//         registration.addCraftingStation(CATEGORY_BREEDING, new ItemStack(ModBlocks.BREEDER));
//         registration.addCraftingStation(CATEGORY_CONVERTING, new ItemStack(ModBlocks.CONVERTER));
//         registration.addCraftingStation(CATEGORY_INCUBATING, new ItemStack(ModBlocks.INCUBATOR));
//     }
// 
//     @Override
